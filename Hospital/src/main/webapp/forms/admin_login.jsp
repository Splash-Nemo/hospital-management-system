...
<body>
	...
	<div class="w-100">
			...
			<div class="row g-0">
				...
				<div class="col-md-8 ">
					<div class="card-body">
						...
						<form action="<%=application.getContextPath()%>/adminLogin"
							method="post">
							<div class="mb-3">
							...
							<div class="mb-3">
								Don't have an account? <a href="admin_register.jsp">Click Here</a>
							</div>
		...
		<%
		String msg = (String) session.getAttribute("adminLoginMsg");
		if (msg != null) {
		%>
